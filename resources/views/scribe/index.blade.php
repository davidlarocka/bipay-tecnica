...
* Permite al usuario autenticado modificar sus datos personales.</a>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    ...
                    <ul id="tocify-header-gestion-de-billetera" class="tocify-header">
                <li class="tocify-item level-1" data-unique="gestion-de-billetera">
                    <a href="#gestion-de-billetera">Gestión de Billetera</a>
                </li>
                                    <ul id="tocify-subheader-gestion-de-billetera" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="gestion-de-billetera-POSTapi-transfer">
                                <a href="#gestion-de-billetera-POSTapi-transfer">Realizar Transferencia
* Permite enviar dinero de la cuenta del usuario autenticado a otro usuario mediante su email.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-billetera-GETapi-users-balances-csv">
                                <a href="#gestion-de-billetera-GETapi-users-balances-csv">Exportar Usuarios a CSV
* Genera y descarga un archivo CSV con el listado de todos los usuarios
y sus saldos actuales, usando ";" como delimitador.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-billetera-GETapi-users-total-transferred">
                                <a href="#gestion-de-billetera-GETapi-users-total-transferred">Promedio de transferencias
* Obtiene el valor medio de las transferencias enviadas por cada usuario que ha operado.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-billetera-GETapi-users-average-transferred">
                                <a href="#gestion-de-billetera-GETapi-users-average-transferred">GET api/users/average-transferred</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="gestion-de-billetera">Gestión de Billetera</h1>

    <p>APIs para manejar saldos, transferencias y reportes de usuarios.</p>

                                <h2 id="gestion-de-billetera-POSTapi-transfer">Realizar Transferencia
* Permite enviar dinero de la cuenta del usuario autenticado a otro usuario mediante su email.</h2>

<p>
</p>

<ul>
<li><small class="badge badge-warning">Restricción</small> Límite diario de 5,000 unidades.</li>
<li>@bodyParam email string required El correo electrónico del destinatario. Example: receptor@correo.com</li>
</ul>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;L&iacute;mite diario excedido&quot;
}</code>
 </pre>
    </span>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-transfer"
               value="qkunze@example.com"
               data-component="body">
    <br>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>El monto a transferir. Debe ser mayor a 0. Example: <code>150.5</code></p>
        </div>
        </form>

                    <h2 id="gestion-de-billetera-GETapi-users-balances-csv">Exportar Usuarios a CSV
* Genera y descarga un archivo CSV con el listado de todos los usuarios
y sus saldos actuales, usando &quot;;&quot; como delimitador.</h2>

<p>
</p>

<ul>
<li>@endpoint GET api/users/balances/csv</li>
</ul>

<span id="example-requests-GETapi-users-balances-csv">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8081/api/users/balances/csv" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8081/api/users/balances/csv"
);
...
<span id="example-responses-GETapi-users-balances-csv">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>

<code class="language-json" style="max-height: 300px;">(binary/csv)</code>
 </pre>
    </span>
<span id="execution-results-GETapi-users-balances-csv" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-users-balances-csv"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-users-balances-csv"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-users-balances-csv" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-users-balances-csv">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-users-balances-csv" data-method="GET"
      data-path="api/users/balances/csv"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-users-balances-csv', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-users-balances-csv"
                    onclick="tryItOut('GETapi-users-balances-csv');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-users-balances-csv"
                    onclick="cancelTryOut('GETapi-users-balances-csv');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-users-balances-csv"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/users/balances/csv</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-users-balances-csv"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-users-balances-csv"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
<br>
<p>Nombre El nombre completo del usuario.</p>
        </div>
                        <h2 id="gestion-de-billetera-GETapi-users-total-transferred">Promedio de transferencias
* Obtiene el valor medio de las transferencias enviadas por cada usuario que ha operado.</h2>

<p>
</p>

<ul>
<li>@queryParam sort string Campo por el que ordenar (promedio_transferido o total_transacciones). Default: promedio_transferido.</li>
</ul>

<span id="example-requests-GETapi-users-total-transferred">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8081/api/users/total-transferred" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8081/api/users/total-transferred"
);
...
<span id="execution-results-GETapi-users-total-transferred" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-users-total-transferred"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-users-total-transferred"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-users-total-transferred" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-users-total-transferred">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-users-total-transferred" data-method="GET"
      data-path="api/users/total-transferred"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-users-total-transferred', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-users-total-transferred"
                    onclick="tryItOut('GETapi-users-total-transferred');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-users-total-transferred"
                    onclick="cancelTryOut('GETapi-users-total-transferred');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-users-total-transferred"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/users/total-transferred</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-users-total-transferred"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-users-total-transferred"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="gestion-de-billetera-GETapi-users-average-transferred">GET api/users/average-transferred</h2>
...
<span id="example-requests-GETapi-users-average-transferred">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8081/api/users/average-transferred" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8081/api/users/average-transferred"
);
...
<span id="execution-results-GETapi-users-average-transferred" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-users-average-transferred"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-users-average-transferred"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-users-average-transferred" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-users-average-transferred">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-users-average-transferred" data-method="GET"
      data-path="api/users/average-transferred"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-users-average-transferred', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-users-average-transferred"
                    onclick="tryItOut('GETapi-users-average-transferred');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-users-average-transferred"
                    onclick="cancelTryOut('GETapi-users-average-transferred');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-users-average-transferred"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/users/average-transferred</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-users-average-transferred"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-users-average-transferred"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
